    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if {$if CompilerVersion = 23} (lGetCellTextEventArgs.StaticText <> '') {$else} not lGetCellTextEventArgs.StaticText.IsEmpty {$ifend} and (toShowStaticText in TStringTreeOptions(CrackTree.TreeOptions).StringOptions) then
